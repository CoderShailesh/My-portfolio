    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap">
          ...
          <motion.a
            href="https://www.instagram.com/ping_shailesh/"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mx-3"
          ...
          <motion.a
            href="https://www.facebook.com/ping.shailesh"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mx-3"
      ...
      "
        >
          ...
          <nav className="flex items-center justify-center flex-wrap mt-4">
            ...
            <button
              onClick={() => setMode(mode === "light" ? "dark" : "light")}
              className={`w-6 h-6 ml-4 flex items-center justify-center rounded-full p-1
      ${mode === "light" ? "bg-dark text-light" : "bg-light text-dark"}
      `}
            >
              {mode === "light" ? (
